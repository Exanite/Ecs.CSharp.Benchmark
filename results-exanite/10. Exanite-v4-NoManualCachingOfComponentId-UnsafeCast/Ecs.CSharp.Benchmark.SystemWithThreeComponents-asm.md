...
; Ecs.CSharp.Benchmark.SystemWithThreeComponents.Exanite()
       mov       rsi,[rdi+88]
       jmp       qword ptr [7F48CD6AF660]; Ecs.CSharp.Benchmark.SystemWithThreeComponents.UpdateExaniteQuery(Exanite.Myriad.Ecs.IArchetypeView)
...
; Ecs.CSharp.Benchmark.SystemWithThreeComponents.UpdateExaniteQuery(Exanite.Myriad.Ecs.IArchetypeView)
       ...
       lea       rsi,[rbp-38]
       call      qword ptr [7F48CD6AF738]; Exanite.Myriad.Ecs.Queries.QueryView.GetArchetypeMatchResult()
       mov       rax,[rbp-30]
       xor       ebx,ebx
       xor       r15d,r15d
       test      rax,rax
...
M01_L09:
       call      qword ptr [7F48C7C2F5E8]
       int       3
M01_L10:
       mov       r11,7F48C6C42158
       call      qword ptr [r11]
       mov       rbx,rax
       mov       r15d,edx
