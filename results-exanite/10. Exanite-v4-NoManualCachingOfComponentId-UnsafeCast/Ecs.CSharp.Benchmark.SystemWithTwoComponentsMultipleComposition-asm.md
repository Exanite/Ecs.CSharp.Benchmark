...
; Ecs.CSharp.Benchmark.SystemWithTwoComponentsMultipleComposition.Exanite()
       mov       rsi,[rdi+88]
       jmp       qword ptr [7F8B1A5A54E8]; Ecs.CSharp.Benchmark.SystemWithTwoComponentsMultipleComposition.UpdateExaniteQuery(Exanite.Myriad.Ecs.IArchetypeView)
...
; Ecs.CSharp.Benchmark.SystemWithTwoComponentsMultipleComposition.UpdateExaniteQuery(Exanite.Myriad.Ecs.IArchetypeView)
       ...
       lea       rsi,[rbp-30]
       call      qword ptr [7F8B1A5A55C0]; Exanite.Myriad.Ecs.Queries.QueryView.GetArchetypeMatchResult()
       mov       rax,[rbp-28]
       xor       ebx,ebx
       xor       r15d,r15d
       test      rax,rax
...
M01_L08:
       call      qword ptr [7F8B14A2F5E8]
       int       3
M01_L09:
       mov       r11,7F8B13A42140
       call      qword ptr [r11]
       mov       rbx,rax
       mov       r15d,edx
