...
```assembly
; Ecs.CSharp.Benchmark.SystemWithTwoComponentsMultipleComposition.Frent_QueryInline()
       push      rbp
       mov       rbp,rsp
       mov       rax,[rdi+30]
       mov       rax,[rax+10]
...
; Ecs.CSharp.Benchmark.SystemWithTwoComponentsMultipleComposition.Exanite()
       mov       rsi,[rdi+88]
       jmp       qword ptr [7F0A86BB5560]; Ecs.CSharp.Benchmark.SystemWithTwoComponentsMultipleComposition.UpdateExaniteQuery(Exanite.Myriad.Ecs.IArchetypeView)
...
M01_L10:
       call      qword ptr [7F0A86A76898]
       int       3
M01_L11:
       lea       rsi,[rbp-38]
       call      qword ptr [7F0A86BB56C8]; Exanite.Myriad.Ecs.Queries.QueryView.GetArchetypeMatchResultCold()
       mov       rbx,[rbp-30]
       jmp       near ptr M01_L01
M01_L12:
       call      qword ptr [7F0A8103F5E8]
       int       3
M01_L13:
       mov       r11,7F0A80052128
       call      qword ptr [r11]
       mov       r15,rax
       mov       r14d,edx
