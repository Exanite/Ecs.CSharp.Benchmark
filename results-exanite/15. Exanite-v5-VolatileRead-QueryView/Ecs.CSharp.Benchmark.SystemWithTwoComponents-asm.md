...
; Ecs.CSharp.Benchmark.SystemWithTwoComponents.Exanite()
       mov       rsi,[rdi+88]
       jmp       qword ptr [7EFE439C5BF0]; Ecs.CSharp.Benchmark.SystemWithTwoComponents.UpdateExaniteQuery(Exanite.Myriad.Ecs.IArchetypeView)
...
M01_L09:
       call      qword ptr [7EFE439C5D10]; Exanite.Myriad.Ecs.Queries.QueryView.GetMatchResultCold(Exanite.Myriad.Ecs.Queries.QueryView, MatchResult)
       mov       rsi,rax
       jmp       near ptr M01_L00
M01_L10:
       call      qword ptr [7EFE3E03F5E8]
       int       3
M01_L11:
       mov       r11,7EFE3D051978
       call      qword ptr [r11]
       mov       rbx,rax
       mov       r15d,edx
