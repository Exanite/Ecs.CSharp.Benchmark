    ...
    public partial class SystemWithThreeComponents
    {
        ...
        private sealed class ExaniteEcsContext : ExaniteEcsBaseContext
        {
            public ExaniteEcsContext(int entityCount, int _) : base()
            {
                ...
                {
                    CommandBuffer.Create().Set(new Component1()).Set(new Component2()).Set(new Component3());
                }
        ...
        [Query]
        private void ExaniteEcsQuery(ref Component1 component1, ref Component2 component2, ref Component3 component3)
        {
            component1.Value++;
            component2.Value++;
            component3.Value++;
